"""
    Team ZARJ task 1, checkpoint 2 code - pitch and yaw
"""
import rospy
...
class CheckpointA2(ZarjCheckpoint):
    """ The class that drives checkpoint 2 in task 1 """

    def __init__(self, task):
        ZarjCheckpoint.__init__(self, task, 2)
        self.sub = None
        self.satellite = None
